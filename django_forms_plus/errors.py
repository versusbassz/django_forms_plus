...
def get_error_message(name: str, error_name: str, meta,
                      global_messages: dict) -> str:
    error_value = f'error_code: {error_name}'

    # search in DfpMeta.error_messages -> name
    # TODO use native Form.Meta.errors_messages
    #      and remove the custom helper attribute
